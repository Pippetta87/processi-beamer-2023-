...
\usepackage{sources}
\usepackage{mathOp}
\title{Processi astrofisici - Gennaio 2024}
...
\part{Radiative Transfer}%\linkdest{evolutivemodels}
\begin{frame}{this part toc}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\begin{itemize}
    \item Photons Absorption/Emission, Einstein Coeff, E/A profile
    \item Gas of photons, Gas of particles: equilibrium distro - LTE
    \item Radiative transfer (RTE) - optical depth: stellar Interior/Atmosphere - Limb Darkening
    \item Photons scattering
    \item Moments of RTE
    \item Opacity sources: Scattering, Inverse Brehmstralug - polarization
    \item Saha/Boltzman equation for excited/ionization states
    \item Opacity sources: kramer's ($\Pelectron$ scattering???), Atomic Lines
    \item Lines Width: Semiclassical Model, collisions
\end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
\tableofcontents
